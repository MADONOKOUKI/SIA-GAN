...
val=3
alpha=0.4
python tanaka_cifar10_LE_instahide_mixup.py --alpha="$alpha" --num_of_keys="$val" --e=155 --tensorboard_name tanaka_cifar10_LE_instahide_mixup > tanaka_cifar10_LE_instahide_"$val"_"$alpha"_mixup.txt
