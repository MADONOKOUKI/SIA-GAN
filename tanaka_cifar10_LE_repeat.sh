...
val=1
python tanaka_cifar10_LE_repeat.py --num_of_keys="$val" --e=155 --tensorboard_name tanaka_adaptation_network_cifar10_LE_repeat --training_model_name tanaka_adaptation_network_cifar10_LE_repeat.t7 --json_file_name tanaka_adaptation_network_cifar10_LE_repeat.json > tanaka_cifar10_LE_"$val"_repeat.txt
