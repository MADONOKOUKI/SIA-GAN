...
val=3
alpha=0.2
python tanaka_cifar10_LE_multitask_same_dagaaug.py --alpha="$alpha" --num_of_keys="$val" --e=155 --tensorboard_name tanaka_adaptation_network_cifar10_LE_multitask_same_dagaaug --training_model_name tanaka_adaptation_network_cifar10_LE_multitask_same_dagaaug.t7 --json_file_name tanaka_adaptation_network_cifar10_LE_multitask_same_dagaaug.json > tanaka_cifar10_LE_multitask_same_dagaaug_"$val"_"$alpha".txt
