...
val=1
alpha=0.2
python tanaka_cifar10_LE_mixup_with_noise.py --alpha="$alpha" --num_of_keys="$val" --e=155 --tensorboard_name tanaka_adaptation_network_cifar10_LE_mixup_with_noise --training_model_name tanaka_adaptation_network_cifar10_LE_mixup_with_noise.t7 --json_file_name tanaka_adaptation_network_cifar10_LE_mixup_with_noise.json > tanaka_cifar10_LE_mixup_with_noise_"$val"_"$alpha".txt
