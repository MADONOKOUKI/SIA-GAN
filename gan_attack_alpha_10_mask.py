...
for epoch in range(opt.n_epochs):
    ...
    for ii, (imgs, labels) in enumerate(trainloader):
        ...
        save_image(((z+1)/2.0).data, opt.directory_name + "/train_inputs%d.png" % epoch, nrow=5, normalize=True)
        save_image(((gen_imgs + 1.0)/2).data, opt.directory_name + "/train_%d.png" % epoch, nrow=5, normalize=True)
